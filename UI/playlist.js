import { classSelectorMaker, create, selectByClass } from "../utils/dom-functions.js";
...
export function controlPlaylist(){
    ...
    const pauseSvgContent =  `<g><path class = "playlist-btn" d="M4 2h5v20H4V2zm11 20h5V2h-5v20z"></path></g>`,
        ...
        $playBtn = selectByClass((selectors.playlistBtn)),
        $soundBtn = selectByClass((selectors.soundBtn)),
        $songName = selectByClass((selectors.songName)),
        $volumeBar = selectByClass((selectors.volumeBar)),
        $audio = create('audio')
